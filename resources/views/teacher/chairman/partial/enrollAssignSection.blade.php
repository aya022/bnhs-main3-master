            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control nameOfStudent" name="fullname_again" style="text-transform: capitalize;" readonly>
                        </div>
                    <div class="row">
                        ...
                        <input type="text" class="form-control" name="lrn_again" maxlength="12" readonly>
                        </div>
                    </div>
                    <div class="form-group mb-3">
