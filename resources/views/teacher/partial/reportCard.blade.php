...
<body onload="window.print()">
    ...
    <table>
        ...
        <tr>
            <td colspan="3" style="text-align:left"><img src="{{ asset('image/logo/dept.png') }}" width="70%"></td>
            <td class="" style="text-align:center" width="50%">
                ...
                <small style="font-size: 11px"><b>BALAOGAN NATIONAL HIGH SCHOOL</b></small><br>
                <small>Balaogan, Camarines Sur</small>
            </td>
            <td colspan="3" style="text-align:right"><img src="{{ asset('image/logo/bn.jpg') }}" width="70%"></td>
        </tr>
        <tr>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td colspan="3" style="text-align: left; border-bottom:1px solid black;"><small>{{ $data[0]->fullname }}</small></td>
