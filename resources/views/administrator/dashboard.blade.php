        ...
        <div class="container-fluid ">
            <div class="row" style="margin-top: -10px;">
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="callout callout-info border-top-0 border-bottom-0 border-end-0 elevation-2 bg-white dark:bg-dark">
                        <div class="callout-icon  ">
                            <i class="fas fa-user-edit icon-color" style="font-size: 20px"></i>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="callout callout-info border-top-0 border-bottom-0 border-end-0 elevation-2 bg-white dark:bg-dark">
                        <div class="callout-icon">
                            <i class="fas fa-user icon-color" style="font-size: 20px"></i>
                        </div>
                        <div class="callout-wrap">
                            <div class="callout-header">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="callout callout-info border-top-0 border-bottom-0 border-end-0 elevation-2 bg-white dark:bg-dark">
                        <div class="callout-icon">
                            <i class="fas fa-users icon-color" style="font-size:20px"></i>
                        </div>
                        <div class="callout-wrap">
                            <div class="callout-header">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <div class="callout callout-info border-top-0 border-bottom-0 border-end-0 elevation-2 bg-white dark:bg-dark">
                        <div class="callout-icon">
                            <i class="fas fa-copy icon-color" style="font-size: 20px;"></i>
                        </div>
                        <div class="callout-wrap">
                            <div class="callout-header">
